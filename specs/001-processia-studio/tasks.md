...
**État au 10 septembre 2026 : T001 et T002 vérifiées localement ; T003 à T012 non commencées.** Les chemins sont proposés dans le plan et sont confirmés ou ajustés à chaque tranche. Chaque ligne représente une tranche métier ; à l’intérieur, traiter un seul comportement par cycle Red → Green → Refactor. Les invariants de qualité et de sécurité sont intégrés dès les tranches concernées, T012 vérifie leur tenue globale.
...
- [ ] **[US04] T003-R** : écrire le prochain test public pour le comportement : Une tâche conserve rôle, outil, entrée et sortie ; les identifiants restent stables après renommage. Observer son échec pour la bonne raison.
- [ ] **[US04] T003-G** : implémenter le minimum qui satisfait ce test ; exécuter les vérifications pertinentes.
- [ ] **[US04] T003-F** : refactoriser avec tests au vert, mettre à jour la trace ; répéter R/G/F pour le comportement suivant.
...
- [ ] **[US01] T005-R** : écrire le prochain test public pour le comportement : Le client voit la synthèse partagée sans extrait, titre ni référence privée ; la révocation est appliquée. Observer son échec pour la bonne raison.
- [ ] **[US01] T005-G** : implémenter le minimum qui satisfait ce test ; exécuter les vérifications pertinentes.
- [ ] **[US01] T005-F** : refactoriser avec tests au vert, mettre à jour la trace ; répéter R/G/F pour le comportement suivant.
...
- [ ] **[US04] T008-G** : implémenter le minimum qui satisfait ce test ; exécuter les vérifications pertinentes.
- [ ] **[US04] T008-F** : refactoriser avec tests au vert, mettre à jour la trace ; répéter R/G/F pour le comportement suivant.
...
- [ ] **[US05] T009-R** : écrire le prochain test public pour le comportement : Deux témoignages créent une divergence contextualisée sans arbitrage inventé. La planification et les suggestions en direct sont un complément SHOULD, développé après ce noyau. Observer son échec pour la bonne raison.
- [ ] **[US05] T009-G** : implémenter le minimum qui satisfait ce test ; exécuter les vérifications pertinentes.
- [ ] **[US05] T009-F** : refactoriser avec tests au vert, mettre à jour la trace ; répéter R/G/F pour le comportement suivant.
