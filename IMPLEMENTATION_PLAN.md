...
Version 0.14.0, 11 septembre 2026. Développement local en cours, par tranches verticales TDD.
...
| T010 | US06 | Produire un diagnostic et une feuille de route | Diagnostic, cible et capacité mutualisable vérifiés |
...
Statut : noyaux FR-033 à FR-037 vérifiés localement le 11 septembre 2026. La comparaison actuel/cible couvre le libellé d'une tâche et signale toute révision ultérieure comme devant être réconciliée. La priorité proposée peut être révisée manuellement avec auteur, justification et historique. Une capacité conceptuelle mutualisable relie deux usages tout en conservant leur contexte et leur périmètre d'accès. Le suivi des résultats reste à développer. DEC-07 bloque toujours la méthode de score et le format métier définitifs.
...
| Studio consultant | US06, FR-033 à FR-037 | Le bouton diagnostic était absent | Diagnostic, feuille de route, capacité mutualisable et comparaison actuel/cible sont visibles dans Chromium |
